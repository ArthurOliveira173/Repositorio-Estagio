...
urlpatterns = [
    ...
    path('admin/<int:aluno_id>', views.admAluno, name='admAluno'),
    ...
    path('admin/<int:monitor_id>', views.admMonitor, name='admMonitor'),
    ...
    path('admin/<int:tutor_id>', views.admTutor, name='admTutor'),
    ...
    path('admin/<int:interprete_id>', views.admInterprete, name='admInterprete'),
