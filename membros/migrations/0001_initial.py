# Generated by Django 4.1.2 on 2022-12-07 22:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alu_endereco_cidade', models.CharField(choices=[('01', 'Assis Brasil'), ('02', 'Brasileia'), ('03', 'Cruzeiro Do Sul'), ('04', 'Feijo'), ('05', 'Mancio Lima'), ('06', 'Manoel Urbano'), ('07', 'Placido De Castro'), ('08', 'Rio Branco'), ('09', 'Sena Madureira'), ('10', 'Senador Guiomard'), ('11', 'Tarauaca'), ('12', 'Xapuri'), ('13', 'Acrelandia'), ('14', 'Bujari'), ('15', 'Capixaba'), ('16', 'Epitaciolandia'), ('17', 'Jordão'), ('18', 'Marechal Thaumaturgo'), ('19', 'Porto Acre'), ('20', 'Porto Walter'), ('21', 'Rodrigues Alvez'), ('22', 'Santa Rosa Do Purus')], db_column='alu_endereco_cidade', max_length=255)),
                ...
                ('alu_periodo_academico', models.CharField(choices=[('1', '1º Período'), ('2', '2º Período'), ('3', '3º Período'), ('4', '4º Período'), ('5', '5º Período'), ('6', '6º Período'), ('7', '7º Período'), ('8', '8º Período'), ('9', '9º Período'), ('10', '10º Período')], db_column='alu_periodo_academico', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mon_endereco_cidade', models.CharField(choices=[('01', 'Assis Brasil'), ('02', 'Brasileia'), ('03', 'Cruzeiro Do Sul'), ('04', 'Feijo'), ('05', 'Mancio Lima'), ('06', 'Manoel Urbano'), ('07', 'Placido De Castro'), ('08', 'Rio Branco'), ('09', 'Sena Madureira'), ('10', 'Senador Guiomard'), ('11', 'Tarauaca'), ('12', 'Xapuri'), ('13', 'Acrelandia'), ('14', 'Bujari'), ('15', 'Capixaba'), ('16', 'Epitaciolandia'), ('17', 'Jordão'), ('18', 'Marechal Thaumaturgo'), ('19', 'Porto Acre'), ('20', 'Porto Walter'), ('21', 'Rodrigues Alvez'), ('22', 'Santa Rosa Do Purus')], db_column='mon_endereco_cidade', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tut_endereco_cidade', models.CharField(choices=[('01', 'Assis Brasil'), ('02', 'Brasileia'), ('03', 'Cruzeiro Do Sul'), ('04', 'Feijo'), ('05', 'Mancio Lima'), ('06', 'Manoel Urbano'), ('07', 'Placido De Castro'), ('08', 'Rio Branco'), ('09', 'Sena Madureira'), ('10', 'Senador Guiomard'), ('11', 'Tarauaca'), ('12', 'Xapuri'), ('13', 'Acrelandia'), ('14', 'Bujari'), ('15', 'Capixaba'), ('16', 'Epitaciolandia'), ('17', 'Jordão'), ('18', 'Marechal Thaumaturgo'), ('19', 'Porto Acre'), ('20', 'Porto Walter'), ('21', 'Rodrigues Alvez'), ('22', 'Santa Rosa Do Purus')], db_column='tut_endereco_cidade', max_length=255)),
