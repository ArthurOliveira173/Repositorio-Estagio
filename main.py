...
cursoDao.AdicionarCurso((4, "Nome curso", 8, 1))
cursoDao.AdicionarCurso((5, "Nome curso2", 8, 2))
cursoDao.AdicionarCurso((6, "Nome curso3", 8, 3))
cursoDao.AdicionarCurso((7, "Nome curso4", 8, 4))

cursoDao.removerCurso("cur_id", 7)
