...
class InterpreteDao:
    ...
    def AdicionarInterprete(self, vetorAtributos):
    ...
    def listarInterprete(self, atributo, valor):
        cursor = self._conexao.cursor()
    ...
    def alterarInterprete(self, atributo, valor, linha_id):
        cursor = self._conexao.cursor()
    ...
    def removerInterprete(self, atributo, valor):
        cursor = self._conexao.cursor()
